    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            List {
                ...
                if vm.loadedSeries.isEmpty && vm.loadedVolumes.isEmpty {
                    HStack {
                        Spacer()
                        VStack(spacing: 8) {
                            ...
                            Text("No studies loaded")
                                .foregroundColor(.secondary)
                            Text("Import a DICOM folder or NIfTI file to begin")
                                .font(.caption)
                                .foregroundColor(.secondary)
    ...
    private var headerButtons: some View {
        VStack(spacing: 8) {
            ...
            Button {
                ...
                Label("Add Overlay (PET)", systemImage: "square.2.stack.3d")
                    .frame(maxWidth: .infinity)
            }
            .buttonStyle(.bordered)
            .controlSize(.small)
