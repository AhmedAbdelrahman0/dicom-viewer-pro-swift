...
public enum GAAINReferencePipeline {
    ...
    public static func makeBuildPlan(summary: GAAINReferenceDatasetSummary,
        ...
        return GAAINReferenceBuildPlan(
            ...
            jobs: tracerJobs,
            notes: [
                "This package builds research reference artifacts from public GAAIN Centiloid downloads.",
    ...
    public static func remoteExecutionPlan(from plan: GAAINReferenceBuildPlan,
        ...
        GAAINReferenceBuildPlan(
            ...
            jobs: plan.jobs,
            notes: plan.notes + [
                "Remote execution plan generated by Tracer. Source and output roots are DGX/Spark paths."
            ]
        )
    }
    ...
    private static func readme(summary: GAAINReferenceDatasetSummary,
        ...
        return """
        # GAAIN Centiloid Reference Build Package

        This package prepares Tracer brain PET reference artifacts from the public GAAIN Centiloid downloads.
