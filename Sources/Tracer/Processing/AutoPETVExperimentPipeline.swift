...
public enum AutoPETVDGXPipeline {
    ...
    private static func readme(experiment: AutoPETVExperimentConfig) -> String {
        ...
        AutoPET V remote-workstation package generated by Tracer. It is designed to run
        beside your local app while the remote workstation does the heavy lifting.
        ...
        - Remote dataset root: \(experiment.sparkDatasetRoot)
        - Model env file: \(experiment.sparkModelEnvironmentFile)

        Expected Python packages on the remote workstation are listed in `requirements.txt`.
...
def require_imaging_stack():
    try:
        ...
        raise RuntimeError(
            "AutoPET V remote scripts require the Python imaging stack. "
